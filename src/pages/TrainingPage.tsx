    ...
    <>
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">
            Training & <span className="text-carex-blue">Empowerment</span>
          </h1>
          <p className="text-gray-600 text-center max-w-3xl mx-auto">
            Learn the art and science of formulating high-quality cleaning products through our specialized Bukleen Training Program
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-2xl font-bold mb-6">Bukleen Training Program</h2>
            <p className="mb-4">
              At Carex Products (Nigeria) Limited, we believe in empowering individuals and businesses to succeed in the fast-growing cleaning products industry. Through our specialized Bukleen Training Program, we offer hands-on training for aspiring entrepreneurs, startups, and organizations interested in learning the art and science of formulating and producing high-quality cleaning products.
            </p>
            <p className="mb-4">
              Our comprehensive training covers the formulation and production of car wash liquids, laundry detergents, bleach, toilet wash, and more. Beyond production skills, we guide participants through the critical process of product registration in line with Nigerian regulatory standards, ensuring they are fully compliant and ready for the market.
            </p>
            <p className="mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center p-6 border border-gray-200 rounded-lg">
              ...
              <p className="text-gray-600">
                Master the science behind creating effective car wash liquids, laundry detergents, bleach, and toilet wash products.
              </p>
            </div>
        ...
        <div className="mt-16 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center mb-8 font-semibold text-carex-blue">
              Join the Bukleen Training Program today—and take your first step toward building a sustainable and profitable brand.
            </p>
          </div>
